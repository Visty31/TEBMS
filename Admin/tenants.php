...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <?php } ?>
    <?php if ($type == 'admin' || $type == 'staff') { ?>
    <li class="btn btn-default btn-xs"><a href="tenants.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Tenants</a></li>
    <?php } ?>
  </ul>
<hr color="#999999" />
    ...
    <div class="modal-dialog" style="width:400px;">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Tenant Electricity Billing System</h4>
        </div>
  ...
  <!-------------------------- modal ends ---------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5>System Tenants</h5>
                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal"> + Add tenant</button>
