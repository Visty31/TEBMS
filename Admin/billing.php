...
if (isset($_POST['add']))
	...
	include 'db.php';
		 ...
		 mysqli_query($conn,"INSERT INTO  owners (id,fname,lname,first,room,meter,contact) 
		 VALUES ('$id','$fname','$lname','$first','$room','$meter','$contact')"); 
...
<title>Tenant Electricity Billing System</title>
<style type="text/css">
#wrapper{
 width:100%;
 margin:0 auto;
...
<div class="container">
<div id="wrapper">
  <h1><center><b>Tenant Electricity  Billing System</b></center></h1>
  ...
  <ul class="nav nav-pills">
    ...
    <?php } ?>
    <?php if ($type == 'admin' || $type == 'staff') { ?>
    <li><a href="tenants.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Tenants</a></li>
    <?php } ?>
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
              ...
              <div class="panel-body">
               <h1 align="center" style="font:Verdana, Geneva, sans-serif; font-weight:bolder;"><?php echo $tenant; ?></h1>
              </div>
              <a href="tenants.php"><div class="panel-footer"><span class="alert-link glyphicon glyphicon-circle-arrow-right"></span>View</div></a>
         </div>
      </div>
    </div>
    <?php } ?>
    ...
    <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
			  ...
			  $add=mysqli_query($conn,"Select SUM(unit) from Bill");
