...
<div id="wrapper">
  ...
  <span><?php echo $sessionfname;?></span><a href="logout.php"><span class="btn btn-danger  glyphicon glyphicon-log-out">&nbsp;Logout</span></a>
  </div>
  <ul class="nav nav-pills">
    <li class="btn btn-default btn-xs"><a href="bill.php"><span class="glyphicon glyphicon-usd"></span>&nbsp;Home</a></li>
  </ul>
<hr color="#999999" />
    ...
    <!-------- home panel ----------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5>My Details</h5></div>
            </div>
